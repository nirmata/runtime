...
var (
	...
	ErrNotAProtocolValue = errors.New(`not a protocol token ("ssh", "tls", "tls/<alpn>", "http1", "h2c", "quic", "unknown") or "*"`)
)
...
//   - a bare token (ssh, tls, http1, h2c, quic, unknown) yields Protocol
...
func ParseProtocolValue(raw string) (ProtocolValue, error) {
	...
	case ProtocolSSH, ProtocolTLS, ProtocolHTTP1, ProtocolH2C, ProtocolQUIC, ProtocolUnknown:

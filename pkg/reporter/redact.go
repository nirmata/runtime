...
// value on its way into a Report. Like runtimeevent.Redacted it is a constant:
// there is no knob, flag, or option that changes or disables it.
...
// truncated at the header NAME so no value can ride along.
